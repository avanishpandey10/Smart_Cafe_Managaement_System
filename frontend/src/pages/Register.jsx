    ...
    <div className="min-h-screen bg-dark-700 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-cafe-500 mt-1 font-body">Create your account</p>
        </div>

        <div className="card shadow-xl border-cafe-200">
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-display text-2xl font-bold text-cafe-800">Register</h2>
            <LanguageSwitcher />
          </div>
          ...
          <p className="text-center text-sm text-cafe-500 mt-4">
            ...
            <Link to="/login" className="text-forest-500 hover:underline font-medium">{t('nav.login')}</Link>
          </p>
        </div>
      </div>
    </div>
